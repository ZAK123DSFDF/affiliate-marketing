                  ...
                  if (typeof q[1] === FUNC_TYPE && !(q[1].exec && q[1].test)) {
                    ...
                    if (q.length == 3) {
                      ...
                      this[q[0]] = match
                        ? q[3].apply(
                            this,
                            [match.replace(q[1], q[2])].concat(q.slice(4)),
                          )
                        : undefined;
                    }
                  }
    ...
    device: [
      ...
      [
        ...
        [
          VENDOR,
          strMapper,
          { OnePlus: ["203", "304", "403", "404", "413", "415"], "*": OPPO },
        ],
        [TYPE, TABLET],
      ],
      [
  ...
  (function () {
    ...
    async function storeRefCode(code) {
      try {
        ...
        document.cookie = `affiliate_data=${encodeURIComponent(JSON.stringify(affiliateData))}; path=/; max-age=${maxAge}`;
      } catch (err) {

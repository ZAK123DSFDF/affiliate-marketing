...
const DialogContent = React.forwardRef<
  ...
  DialogContentProps
>(({ className, children, affiliate = false, ...props }, ref) => {
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        style={{
          backgroundColor:
            (affiliate && dashboardDialog.dialogBackgroundColor) || undefined,
        }}
        className={cn(
      ...
      >
        ...
        <DialogPrimitive.Close
          ...
          style={
            {
              color:
                (affiliate && dashboardDialog.dialogCloseIconColor) ||
                undefined,
              "--tw-ring-color":
                (affiliate && dashboardDialog.dialogCloseIconBorderColor) ||
                undefined,

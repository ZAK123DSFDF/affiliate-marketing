  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        style={{
          backgroundColor: dashboardDialog.dialogBackgroundColor,
        }}
        className={cn(
      ...
      >
        ...
        <DialogPrimitive.Close
          ...
          style={
            {
              color: dashboardDialog.dialogCloseIconColor,
              "--tw-ring-color": dashboardDialog.dialogCloseIconBorderColor,

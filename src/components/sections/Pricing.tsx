...
const pricingPlans = [
  {
    ...
    price: "$49",
    description:
      "Perfect for early-stage SaaS businesses launching their first affiliate program.",
    features: [
      { text: "Up to 50 affiliates", included: true },
      { text: "Basic affiliate dashboard", included: true },
      { text: "Manual payouts", included: true },
      { text: "Email support", included: true },
      { text: "Custom affiliate portal", included: false },
  ...
  },
  {
    ...
    price: "$149",
    description:
      "Ideal for growing SaaS companies looking to scale their affiliate programs.",
    features: [
      { text: "Up to 200 affiliates", included: true },
      { text: "Advanced affiliate dashboard", included: true },
      { text: "Automated payouts", included: true },
      { text: "Priority email support", included: true },
      { text: "Custom affiliate portal", included: true },
  ...
  },
  {
    ...
    price: "$399",
    description:
      "Comprehensive solution for established SaaS businesses with large affiliate networks.",
    features: [
      { text: "Unlimited affiliates", included: true },
      { text: "White-label affiliate portal", included: true },

...
const Features = () => {
  const features = [
    ...
    },
    {
      icon: (
        ...
        >
          ...
          <path d="M15 10h-6a2 2 0 1 0 0 4h6"></path>
        </svg>
      ),
    ...
    },
    {
      ...
      description:
        "Provide your partners with a beautiful, intuitive dashboard to track their performance and earnings.",
    },
    {
      icon: (
        <svg
      ...
      <div className="container mx-auto">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Our platform is meticulously designed to make affiliate marketing
            effortless and effective for SaaS businesses.
          </p>
        </div>
